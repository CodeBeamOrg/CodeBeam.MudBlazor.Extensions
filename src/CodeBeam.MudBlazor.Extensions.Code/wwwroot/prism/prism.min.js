/* PrismJS 1.30.0
https://prismjs.com/download#themes=prism&languages=markup+css+clike+javascript+csharp+json+powershell+cshtml+scss+sql+yaml&plugins=line-numbers */
...
window.MudCode = {
    ...
    enableTabIndent: function (textarea) {
        if (textarea._tabEnabled)
            return;

        textarea._tabEnabled = true;
