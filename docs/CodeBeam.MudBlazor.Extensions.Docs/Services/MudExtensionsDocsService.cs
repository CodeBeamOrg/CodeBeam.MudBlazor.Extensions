...
public class MudExtensionsDocsService
{
    List<MudExtensionComponentInfo> _components = new()
    {
        ...
        new MudExtensionComponentInfo() {Title = "MudDateTimePicker", Component = typeof(MudDateTimePicker<>), Usage = ComponentUsage.Input, IsUnique = false, Description = "Unified generic date and time picker component."},
        ...
        new MudExtensionComponentInfo() {Title = "MudMapper", Component = typeof(MudMapper), Usage = ComponentUsage.Input, IsUnique = true, Description = "A standalone drag-and-drop field mapper. Map source items onto target headers without any file or CSV dependency."},
